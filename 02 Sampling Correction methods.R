...
for (file in FILENAMES){
  ...
  for (method in SAMPLING_METHODS){
    ...
    ### Saving to feather ####
    filename <- sprintf("%s/data/Feather Samples/%s_%s_base_sample.feather", wd, current_iter, method)
    ...
    ### Saving to feather ####
    filename <- sprintf("%s/data/Feather Samples/%s_%s_importance_sample.feather", wd, current_iter, method) 
    ...
    ### Saving to feather ####
    filename <- sprintf("%s/data/Feather Samples/%s_%s_synthetic_sample.feather", wd, current_iter, method) 
