#' Plot difference between sample data income and FULL Amelia income with resulting relevance
#'
#' @description This function is used to show the difference in income between the sample and the
...
#'
#' @param sample_data Output value of compute_income_diff()
#' @param amelia  Income distribution of original AMELIA dataset with bucket size
#' @param padding By how much the relevance function has been padded (i.e. by how much the min/max differ from [0,1])
#' @param show_mean Whether mean should be plotted as a horizontal line
#' @param show_median Whether median should be plotted as a horizontal line
#' @param sample_type Implemented sampling method, gets added to the title if not null
#'
#' @returns Histogram of density of distributions + plot of difference+
#'
#' @export
